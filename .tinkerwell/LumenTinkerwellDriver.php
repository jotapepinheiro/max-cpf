...
class LumenTinkerwellDriver extends TinkerwellDriver
{
    ...
    public function bootstrap($projectPath)
    {
        ...
        class_alias( Respect\Validation\Validator::class, "v");
        class_alias(Respect\Validation\Exceptions\ValidationException::class, "ValidationException");

        class_alias(Carbon\Carbon::class, "Carbon");
        class_alias(Faker\Factory::class, "Faker");
        class_alias(App\Models\User::class, "User");
        class_alias(App\Models\Cpf::class, "Cpf");
    }
